...
import src.megaman.embedding.ltsa as ltsa
import src.megaman.geometry.geometry as geom
from src.megaman.embedding.locally_linear import barycenter_graph
...
def test_ltsa_with_sklearn():
    ...
    sk_Y_ltsa = manifold.LocallyLinearEmbedding(n_neighbors=n_neighbors, n_components=n_components,
                                                method = 'ltsa',
